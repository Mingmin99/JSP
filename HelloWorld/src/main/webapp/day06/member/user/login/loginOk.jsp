...
<body>
    ...
    if (dto != null) {
    	...
    	if (password.equals(dto.getPw())) {
            ...
            if (dto.getStatus().equals("정상") && dto.getUser_permission().equals("사용자")) {
            	
                // 로그인 성공
                session.setAttribute("loginId", dto);
                out.println("<script>alert('로그인 성공'); window.location.href='/HelloWorld/day06/member/user/mypage/mypage.jsp';</script>");
            } else {
